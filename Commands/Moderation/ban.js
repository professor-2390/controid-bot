  ...
  data: new SlashCommandBuilder()
    ...
    .addNumberOption((option) =>
      option
        .setName("days")
        .setDescription(
          `The amount of days that you want the user to stay banned.`
        )
    )
  ...
  async execute(interaction) {
    ...
    if (user.id == interaction.member.user.id) {
      return interaction.reply({
        content: `You can't ban youself, smarty pants!`,
        ephemeral: true,
      });
    }
    ...
    if (
      ...
      return interaction.reply({
        content: `Your roles must be higher than the roles of the person you want to ban!`,
        ephemeral: true,
      });
    }
    ...
    if (!member.bannable) {
      return interaction.reply({
        content: `Make sure that my role is higher than the roles of the person you want to ban!`,
        ephemeral: true,
      });
    }
    ...
    if (!days) {
      ...
      const banEmbed = new MessageEmbed()
        ...
        .setFooter(
          `You can use /unban ${member.user.username} to unban ${member.user.username} earlier or /baninfo ${member.user.username} to view information about his ban.`
        )
        .setTimestamp();
      ...
      const banEmbed = new MessageEmbed()
        ...
        .setFooter(
          `You can use /unban ${member.user.username} to unban ${member.user.username} earlier than ${days} days or /baninfo ${member.user.username} to view information about his ban.`
        )
        .setTimestamp();
